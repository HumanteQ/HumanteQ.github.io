...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_gsap_TweenLite__ = __webpack_require__(57);
...
function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}var SnapHelper=function SnapHelper(component,rowSelector,columnsNumber,maxWidth,submenuSelector){var _this=this;_classCallCheck(this,SnapHelper);this.lastSnapTime=0;this.forced={scrollLeft:0};this.onScroll=function(event){if(window.innerWidth>_this.maxWidth){return;}var row=document.querySelector(_this.rowSelector);if(row){if(Date.now()-_this.lastSnapTime>1500){var active=Math.round(_this.columnsNumber*row.scrollLeft/row.scrollWidth);if(active!=_this.component.state.active){_this.component.setState({active:active});_this.lastSnapTime=Date.now();}}else{requestAnimationFrame(function(){row.scrollLeft=_this.forced.scrollLeft;});}}};this.onComponentUpdate=function(){// https://stackoverflow.com/a/28748160
requestAnimationFrame(function(){if(window.innerWidth>_this.maxWidth){return;}var submenu=document.querySelector(_this.submenuSelector);if(submenu){__WEBPACK_IMPORTED_MODULE_0_gsap_TweenLite___default.a.to(submenu.parentElement,0.4,{scrollLeft:submenu.children[_this.component.state.active].offsetLeft});}var row=document.querySelector(_this.rowSelector);if(row){row.removeEventListener('scroll',_this.onScroll);row.addEventListener('scroll',_this.onScroll);_this.lastSnapTime=Date.now();_this.forced.scrollLeft=row.scrollLeft;console.log('>>',_this.component.state.active);__WEBPACK_IMPORTED_MODULE_0_gsap_TweenLite___default.a.to(_this.forced,0.4,{scrollLeft:Math.round(row.scrollWidth*_this.component.state.active/_this.columnsNumber),onUpdate:function onUpdate(){row.scrollLeft=_this.forced.scrollLeft;}});}});};this.component=component;this.rowSelector=rowSelector;this.columnsNumber=columnsNumber;this.maxWidth=maxWidth;this.submenuSelector=submenuSelector;};/* harmony default export */ __webpack_exports__["a"] = (SnapHelper);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__registerServiceWorker__ = __webpack_require__(76);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_Context__ = __webpack_require__(68);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__components_Products__ = __webpack_require__(69);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__components_Science__ = __webpack_require__(70);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__components_BG__ = __webpack_require__(71);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__components_How__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__components_Main__ = __webpack_require__(73);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__components_Mission__ = __webpack_require__(74);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__SnapHelper__ = __webpack_require__(8);
var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var menuItems=['Executive committee','Managing board','Research & Development','Technology & Data'];var people=[[{name:'Sergey Yakubanets',column:'large-4 animation-1',position:'Co-Founder, Managing Partner',description:'more than 20 years of experience in investments',image:__webpack_require__(58)},{name:'Maxim Katinov',column:'large-4 animation-2',position:'Co-Founder, Managing Partner',description:'',image:__webpack_require__(59)},{name:'Larisa Mararitsa',column:'large-4 animation-3',position:'Partner',description:'Ph.D., Social Psychologist, researcher and specialist in the field of Social Interaction',image:__webpack_require__(60)}],[{name:'Alexander Fenin',column:'large-6 animation-1',position:'Product Manager',description:'MS in Psychology',image:__webpack_require__(61)},{name:'Irina Burlova',column:'large-6 animation-2',position:'Chief Operating Officer',description:'MS in Economics, more than 10 years of experience in HR',image:__webpack_require__(62)}],[{name:'Viktor Nozdrachev',column:'large-4 animation-1',position:'Chief Scientific Adviser',description:'Ph.D., Mathematician',image:__webpack_require__(63)},{name:'Tatyana Orlova',column:'large-4 animation-2',position:'Director, Business Development',description:'Ph.D., Social Psychologist, Expert in the field of talent acquisition and people development',image:__webpack_require__(64)},{name:'Sergey Titov',column:'large-4 animation-3',position:'Data Scientist',description:'Ph.D. candidate in Psychology, Psychologist & Data Scientist',image:__webpack_require__(65)}],[{name:'Mikhail Danilov',column:'large-6 animation-1',position:'Chief Technical Officer',description:'MSE, more than 10 years of experience in R&D projects in Engineering, Software Development and AI',image:__webpack_require__(66)},{name:'Pavel Novikov',column:'large-6 animation-2',position:'Data Scientist',description:'MS in Data Science, Mathematician, programmer, more than 5 years of experience in R&D projects in Data Analysis and Social Networks',image:__webpack_require__(67)}]];var Team=function(_Component){_inherits(Team,_Component);function Team(){var _ref;var _temp,_this,_ret;_classCallCheck(this,Team);for(var _len=arguments.length,args=Array(_len),_key=0;_key<_len;_key++){args[_key]=arguments[_key];}return _ret=(_temp=(_this=_possibleConstructorReturn(this,(_ref=Team.__proto__||Object.getPrototypeOf(Team)).call.apply(_ref,[this].concat(args))),_this),_this.state={active:0,isActive:false},_this.onSlideChange=function(event){_this.setState({isActive:event.detail.index===_this.props.index});if(_this.state.isActive){_this.setState({active:0});}},_this.snapHelper=new __WEBPACK_IMPORTED_MODULE_3__SnapHelper__["a" /* default */](_this,'.body-team .item-descriptions',menuItems.length,1024,'.body-team .active-slide .submenu'),_temp),_possibleConstructorReturn(_this,_ret);}_createClass(Team,[{key:'componentWillMount',value:function componentWillMount(){window.addEventListener('slidechange',this.onSlideChange,false);}},{key:'componentWillUnmount',value:function componentWillUnmount(){window.removeEventListener('slidechange',this.onSlideChange,false);}},{key:'componentDidUpdate',value:function componentDidUpdate(){this.snapHelper.onComponentUpdate();}},{key:'render',value:function render(){var _this2=this;return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{className:'scene-container'},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{className:'jumbotron'},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{className:'container'},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{className:'row grid-x grid-margin-x'},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{className:'col cell medium-12 animation-1'},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('h1',null,__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__RandomLetters__["a" /* default */],{label:'Team',start:this.state.isActive}),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('span',{className:'noscript-only'},'Team')))),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{className:'row grid-x grid-margin-x'},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{className:'col cell large-5 animation-2'},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_responsive___default.a,{query:'(max-device-width: 1024px)'},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{style:{width:'100%',overflowX:'auto',WebkitOverflowScrolling:'touch'}},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('ul',{className:'list-group list-group-flush no-bullet submenu'},menuItems.map(function(item,index){return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('li',{key:'menu-item-'+index,onClick:function onClick(){return _this2.setState({active:index});},className:_this2.state.active==index?'list-group-item submenu-item active':'submenu-item list-group-item inactive'},item,'.');})))),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_responsive___default.a,{query:'(min-device-width: 1025px)'},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('ul',{className:'list-group list-group-flush no-bullet'},menuItems.map(function(item,index){return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('li',{key:'menu-item-'+index,onClick:function onClick(){return _this2.setState({active:index});},className:_this2.state.active==index?'list-group-item active':'list-group-item inactive'},item,'.');})))),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{className:'col cell large-7 item-descriptions animation-3'},people.map(function(group,index){return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{key:'people-group-'+index,className:(_this2.state.active==index?'active':'inactive')+' item-description row grid-x grid-margin-x'},group.map(function(employee,employeeIndex){return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{key:'employee-'+index+'-'+employeeIndex,className:'employee col cell '+employee.column},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{className:'row image'},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{className:'thumbnail team-member-photo'},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('img',{src:employee.image}))),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{className:'row text'},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('h3',null,employee.name),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('p',{className:'lead'},employee.position),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('p',{className:'desc'},employee.description)));}));}))),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{className:'paging'},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{onClick:function onClick(){return _this2.setState({active:Math.max(0,_this2.state.active-1)});}},'<'),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{onClick:function onClick(){return _this2.setState({active:Math.min(3,_this2.state.active+1)});}},'>')))));}}]);return Team;}(__WEBPACK_IMPORTED_MODULE_0_react__["Component"]);/* harmony default export */ __webpack_exports__["a"] = (Team);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__RandomLetters__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__SnapHelper__ = __webpack_require__(8);
var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var menuItems=['The Model','Digital Freud','Vibes','SkillWill','Deep Persona'];var itemDescriptions=['<b class="noscript-only">'+menuItems[0]+':</b> A technology providing an innovative, scientifically based & responsible way of personal profiling through digital footprints collected & stored on a smartphone — allows prediction of various elements of human behavior.','<b class="noscript-only">'+menuItems[1]+':</b> The principle component of the new personality profiling system. A non-commercial Android application, used to collect & analyze a vast amount of digital footprints, supported by classical personality questionnaires & cognitive tests. Its citizen science module allows recruiting respondents the data collection for scientific purposes. <a href="http://www.digitalfreud.io/">www.digitalfreud.io</a>','<b class="noscript-only">'+menuItems[2]+':</b> The former Digital Freud module grown into a separate project. A non-commercial b2c iOS application that allows evaluation of friends & public figures in social networks using a set of criteria in simple, yet captivating mechanics.','<b class="noscript-only">'+menuItems[3]+':</b> An innovative, ai-powered tool of behavioral assessment, based on personal digital footprints analysis. Fast, valid and unbiased way to assess strengths and gaps of individuals and teams. Involving and engaging way to plan personal and team development.','<b class="noscript-only">'+menuItems[4]+':</b> Solutions that allow creation of new interfaces between human & AI, taking into account the social context & psycho-emotional state of user. Empathy AI will customize services & applications by automatically adapting to users.'];var itemPictures=[null/*require('../../images/product-logo-1.svg')*/,null,null,null,null];var Products=function(_Component){_inherits(Products,_Component);function Products(){var _ref;var _temp,_this,_ret;_classCallCheck(this,Products);for(var _len=arguments.length,args=Array(_len),_key=0;_key<_len;_key++){args[_key]=arguments[_key];}return _ret=(_temp=(_this=_possibleConstructorReturn(this,(_ref=Products.__proto__||Object.getPrototypeOf(Products)).call.apply(_ref,[this].concat(args))),_this),_this.state={active:0,isActive:false},_this.onSlideChange=function(event){_this.setState({isActive:event.detail.index===_this.props.index});if(_this.state.isActive){_this.setState({active:0});}},_this.snapHelper=new __WEBPACK_IMPORTED_MODULE_3__SnapHelper__["a" /* default */](_this,'.body-products .item-descriptions',itemDescriptions.length,1024,'.body-products .active-slide .submenu'),_temp),_possibleConstructorReturn(_this,_ret);}_createClass(Products,[{key:'componentWillMount',value:function componentWillMount(){window.addEventListener('slidechange',this.onSlideChange,false);}},{key:'componentWillUnmount',value:function componentWillUnmount(){window.removeEventListener('slidechange',this.onSlideChange,false);}},{key:'componentDidUpdate',value:function componentDidUpdate(){this.snapHelper.onComponentUpdate();}},{key:'render',value:function render(){var _this2=this;return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{className:'scene-container'},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{className:'jumbotron'},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{className:'container'},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{className:'row grid-x grid-margin-x'},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{className:'col cell medium-12 animation-1'},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('h1',null,__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__RandomLetters__["a" /* default */],{label:'Projects',start:this.state.isActive}),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('span',{className:'noscript-only'},'Projects')))),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{className:'row grid-x grid-margin-x'},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{className:'col cell large-5 animation-2'},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_responsive___default.a,{query:'(max-device-width: 1024px)'},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{style:{width:'100%',overflowX:'auto',WebkitOverflowScrolling:'touch'}},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('ul',{className:'list-group list-group-flush no-bullet submenu'},menuItems.map(function(item,index){return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('li',{key:'menu-item-'+index,onClick:function onClick(){return _this2.setState({active:index});},className:_this2.state.active==index?'list-group-item submenu-item active':'submenu-item list-group-item'},item,'.');})))),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_responsive___default.a,{query:'(min-device-width: 1025px)'},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('ul',{className:'list-group list-group-flush no-bullet'},menuItems.map(function(item,index){return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('li',{key:'menu-item-'+index,onClick:function onClick(){return _this2.setState({active:index});},className:_this2.state.active==index?'list-group-item active':'list-group-item'},item,'.');})))),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{className:'col cell large-7 item-descriptions animation-3'},itemDescriptions.map(function(item,index){return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{key:'item-description-'+index,className:_this2.state.active==index?'item-description active':'item-description inactive'},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{className:'row grid-x grid-margin-x'},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_responsive___default.a,{query:'(max-device-width: 1024px)'},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{className:'col cell medium-12'},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('h3',null,menuItems[index],'.'))),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_responsive___default.a,{query:'(min-device-width: 1025px)'},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{className:'col cell medium-8'},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('h3',null,menuItems[index],'.')),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{className:'col cell medium-4 animation-4'},itemPictures[_this2.state.active]?__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('img',{src:itemPictures[_this2.state.active],alt:menuItems[index]}):null))),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{className:'separator-40'}),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('p',{dangerouslySetInnerHTML:{__html:item}}));}))),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{className:'paging'},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{onClick:function onClick(){return _this2.setState({active:Math.max(0,_this2.state.active-1)});}},'<'),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{onClick:function onClick(){return _this2.setState({active:Math.min(4,_this2.state.active+1)});}},'>')))));}}]);return Products;}(__WEBPACK_IMPORTED_MODULE_0_react__["Component"]);/* harmony default export */ __webpack_exports__["a"] = (Products);
...
/***/ })
/******/ ]);
//# sourceMappingURL=main.37bcc1ba.js.map